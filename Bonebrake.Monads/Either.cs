...
public readonly struct Either<TLeft, TRight>
{
	...
	public Either(TLeft left) : this(left.OfMaybe(), Maybe<TRight>.None()) { }
	public Either(TRight right) : this(Maybe<TLeft>.None(), right.OfMaybe()) { }
	public Either(TLeft? left, TRight? right) : this((left?.OfMaybe() ?? Maybe<TLeft>.None()!)!, (right?.OfMaybe() ?? Maybe<TRight>.None()!)!) { }
